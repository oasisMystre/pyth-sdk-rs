...
pub struct MappingAccount {
    ...
    pub next: Address,
    pub products: [Address; MAP_TABLE_SIZE],
}
    ...
    T: Copy,
{
    ...
    pub fn to_price_feed(&self, price_key: &Address) -> PriceFeed {
...
mod test {
    ...
    use crate::state::{PROD_ACCT_SIZE, PROD_HDR_SIZE};

    use super::{PriceInfo, PriceStatus, Rational, SolanaPriceAccount};
    ...
    fn test_trading_price_to_price_feed() {
        ...
        let pubkey = Address::new_from_array([3; 32]);
    ...
    fn test_price_feed_representations_equal() {
        ...
        let old = OldPriceAccount {
            ...
            drv3: 15,
            drv4: 16,
            prod: Address::new_from_array([1; 32]),
            next: Address::new_from_array([2; 32]),
            prev_slot: 19,
            prev_price: 20,
            prev_conf: 21,
            prev_timestamp: 22,
    ...
    fn test_product_account_iter_works() {
        let mut product = super::ProductAccount {
            ...
            px_acc: Address::new_from_array([3; 32]),
